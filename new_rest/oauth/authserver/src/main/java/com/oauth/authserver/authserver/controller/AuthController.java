...
public class AuthController {
      ...
      public void auth(
            ...
            String authCode = authService.issueAuthCode(clientId, redirectUrl);
      ...
      public String token(
            ...
            //TODO
            //check matching among clientId, clientSecret, redirectUrl

            //String accessToken = authService.issueToken(authCode);
            accessToken = authService.issueToken(authCode);
      ...
      public String test() {
            ...
            try {
                  claims = Jwts.parser()
                              .setSigningKey(DatatypeConverter.parseBase64Binary(authService.getTestKey()))
            ...
            String stringified =    claims.getIssuer() + "-" +
                                    claims.getSubject() + "-" +
